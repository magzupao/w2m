...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.w2m.anime.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.w2m.anime.repository.UserRepository.USERS_BY_EMAIL_CACHE);
